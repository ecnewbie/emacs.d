...
| M-,         | ggtags-find-tag-continue   | ggtags-mode           |
| M-.         | ggtags-find-definition     | ggtags-mode           |
| -----       | --------------------       | ---------------       |
...
| occur/helm-occur/helm-multi-occur | global | 使用helm来过滤buffer内容 |
| calc                              | global | 计算器                   |
