* 依赖系统包：
** emacs24、emacs24-el、clang、global[-6.4]、racket。
...
*** multiple-cursors、page-break-lines、paredit、pointback、saveplace、smartparens、switch-window、undo-tree、unfill、visual-regexp、whitespace-cleanup-mode、
...
** flycheck：语法静态检查。
** imenu: 当前buffer函数跳转。
** magit、git-commit-mode、gitignore-mode、gitconfig-mode、git-gutter(显示变化): git前端。
