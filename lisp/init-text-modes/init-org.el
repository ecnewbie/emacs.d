...
(with-eval-after-load 'org
  ...
  (define-key org-mode-map (kbd "C-c I") 'org-cliplink)
...
(with-eval-after-load 'org-capture
  (require 'org-agenda)
  (setq org-default-notes-file (car-safe (org-agenda-files t))))
...
(defun newbie/org-archive-subtree-find-done ()
  "Move the current subtree to the archive with FIND-DONE t."
  (interactive)
  (org-archive-subtree t))
